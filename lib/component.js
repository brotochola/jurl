...
export default class Component extends HTMLElement {
  static registerComponent(classs){
    App.defineComponentsName(classs);
  }
  constructor() {
  ...
  connectedCallback() {
    App.instance.instanciatedComponents.push(this);
    setTimeout(() => {
      this.updateParsedAttributes();
  ...
  disconnectedCallback() {
    ...
    this.observer.disconnect();
    App.instance.instanciatedComponents =
      App.instance.instanciatedComponents.filter(
