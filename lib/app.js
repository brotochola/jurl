...
export default class App {
  ...
  registerCustomElements() {
    App.defineComponentsName(ForTag, "j-for");
    App.defineComponentsName(IfTag, "j-if");
    App.defineComponentsName(DebugTag, "j-debug");
  }
  ...
  static defineComponentsName(classs, name) {
    // debugger
    const newName=convertStringToComponentFriendlyName(classs.name)
